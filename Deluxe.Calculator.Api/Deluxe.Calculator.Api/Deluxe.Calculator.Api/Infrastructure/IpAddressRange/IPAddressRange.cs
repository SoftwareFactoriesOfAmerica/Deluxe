...
{
    // =========================================================================
    // NOTE: this code is from "https://github.com/jsakamoto/ipaddressrange"
    //       was modified by removing references and code that was
    //       based prior to .NET 5.0. Then was re-compiled into a
    //       .NET Core 5.0 project/solution so that there are no
    //       .NET standard references
    //
    //       The need for this utility is to check that an IP is within
    //       an IPAddress range
    // =========================================================================
